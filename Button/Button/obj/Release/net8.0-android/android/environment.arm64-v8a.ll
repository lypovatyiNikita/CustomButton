...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 9873165761617611366, ; hash 0x890487f32dc44a66, from name: libaot-Button.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Button.dll.so
		ptr null; void* handle (0x0)
	}, ; 246
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 11820994382001171610, ; hash 0xa40c9bc297116c9a, from name: Button
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Button.dll.so
		ptr null; void* handle (0x0)
	}, ; 300
	...
	%struct.DSOCacheEntry {
		i64 15884014290524387319, ; hash 0xdc6f5ad711ef37f7, from name: aot-Button.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Button.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
	...
	%struct.DSOCacheEntry {
		i64 16164859265438253333, ; hash 0xe0551ddb58a10115, from name: Button.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Button.dll.so
		ptr null; void* handle (0x0)
	}, ; 417
	...
	%struct.DSOCacheEntry {
		i64 16610666542844148506, ; hash 0xe684f136b0b0fb1a, from name: aot-Button
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Button.dll.so
		ptr null; void* handle (0x0)
	}, ; 429
	...
	%struct.DSOCacheEntry {
		i64 17138218205695040306, ; hash 0xedd72ea7e995db32, from name: libaot-Button
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Button.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7fbacdfe-b5c6-43c7-a323-84c485fada83\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.button\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [21 x i8] c"libaot-Button.dll.so\00", align 1
...
@.DSOCacheEntry.72_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.RegularExpressions.dll.so\00", align 1
@.DSOCacheEntry.73_name = private unnamed_addr constant [38 x i8] c"libaot-System.Threading.Thread.dll.so\00", align 1
@.DSOCacheEntry.74_name = private unnamed_addr constant [31 x i8] c"libaot-System.Threading.dll.so\00", align 1
@.DSOCacheEntry.75_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 1
